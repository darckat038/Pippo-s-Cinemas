select Film.titolo, Film.trama, Film.rating, t2.prezzoTot
from
(
select titolofilm, sum(prezzo) as prezzoTot from
            (select codicebiglietto, codiceproiezione, Parcheggio.prezzo
              from Biglietto
